...
type IDNSMethodsRepository interface {
	GetCollectionName() string
	GetDataSource() *datasources.IMongoDataSource
	GetMany(filter bson.M, limit int) ([]entities.DNS, error)
	Get(filter bson.M) (*entities.DNS, error)
	Create(item entities.DNS) (*entities.DNS, error)
	Update(filter bson.M, update bson.M) (*entities.DNS, error)
	Delete(filter bson.M) error
}

type IDNSRepository struct {
	DataSource     *datasources.IMongoDataSource
	CollectionName string
	Context        context.Context
}

func DNSRepository(dataSource *datasources.IMongoDataSource) IDNSMethodsRepository {
	return &IDNSRepository{
...
func (r *IDNSRepository) GetCollectionName() string {
	return r.CollectionName
}

func (r *IDNSRepository) GetDataSource() *datasources.IMongoDataSource {
	return r.DataSource
}

func (r *IDNSRepository) GetMany(filter bson.M, limit int) ([]entities.DNS, error) {
	if r.DataSource == nil {
...
func (r *IDNSRepository) Get(filter bson.M) (*entities.DNS, error) {
	if r.DataSource == nil {
		return nil, fmt.Errorf("dataSource is nil - connection not established")
	}
...
func (r *IDNSRepository) Create(item entities.DNS) (*entities.DNS, error) {
	if r.DataSource == nil {
		return nil, fmt.Errorf("dataSource is nil - connection not established")
	}
...
func (r *IDNSRepository) Update(filter bson.M, update bson.M) (*entities.DNS, error) {
	if r.DataSource == nil {
		return nil, fmt.Errorf("dataSource is nil - connection not established")
	}
...
func (r *IDNSRepository) Delete(filter bson.M) error {
	if r.DataSource == nil {
